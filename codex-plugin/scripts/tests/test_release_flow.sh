...
printf '# fake release\n' > release.ps1
printf '{"product":"duck","repo_root":"/placeholder","build_target":{"installer_glob":""}}\n' > release-context.json
