...
# model/工具白名单/系统提示词由已注册的 agents/ frontmatter 提供)。
...
EXECUTOR_AGENT="${CURSOR_EXECUTOR_AGENT:-pack-executor}"
CAPABLE_EXECUTOR_AGENT="${CURSOR_CAPABLE_EXECUTOR_AGENT:-pack-executor-capable}"
PLAN_AGENT="${CURSOR_PLAN_AGENT:-plan-writer}"
