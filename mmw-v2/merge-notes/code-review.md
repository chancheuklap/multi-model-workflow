...
## Out-of-ticket findings are this ticket's sub-issues

`SKILL.md` §3: out-of-ticket review findings become this ticket's sub-issues
(`--sub-issue review`) and block nothing. The worker opens them; the reviewer lists
them. The parent is this ticket, not a guess at whose work it is. Upstream rewrites
§3 → keep this parent and this command.
