...
给你的材料里应该有这个仓库自己写下来的标准文件——`CODING_STANDARDS.md`、`CONTRIBUTING.md`，或者这个项目用别的名字放的那一份。**材料里说明了「本仓库没有写下来的标准」也算给到了**，那时只用本文「代码气味基线」一节。
...
- **Data Clumps** —— 同样那几个字段或参数总是一起出现（一个想出生的类型）。→ 把它们捆成一个类型，传这个新类型。
