...
1. **Look before you opine.** The packet is a claim about the world, not evidence of it. Reconstruct the model of the problem from the turns you were given, then read every file, interface, and constraint that model depends on. Do not verdict from the summary.
