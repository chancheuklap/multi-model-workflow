...
# Prelude of every generated page: what the class body below it refers to but
# support.js's own base class does not carry.
SHARED_JS = """const STATE_SEED = { fx: false, toast: "" };
