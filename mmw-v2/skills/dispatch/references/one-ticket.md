...
4. Once the ticket passed or came back, run `<dispatch> land <n>` from any checkout of this repository. It lands the ticket, closes the watch and prints what it did; stderr names anything it left standing.
