"""Generate the all-scenes harness page: every component in every scene (plus each boolean prop negated), so collect_dom_classes.js can read the rendered classes.
