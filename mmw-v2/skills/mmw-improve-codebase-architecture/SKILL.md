...
**按视角分，不按范围分。** 每个人都看第 1 步定下来的整片地方，不要把它切成几块各管一段——最值钱的那类发现恰恰是跨边界的：一个概念散在三个 module 里，一处耦合从 seam 漏进另一个子系统。范围一切，这类问题就没人看得见了。反过来，一个 subagent 同时背五个视角会趋同：它找到第一个候选之后，剩下的注意力都还留在那附近。
