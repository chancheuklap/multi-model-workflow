...
- **Test surfaces.** With a screen contract: the answers that make the repository a runnable environment, in the terms of the `ui-acceptance` skill's `references/product-answers.md`; `target_config.py --check` of that skill is the count.
