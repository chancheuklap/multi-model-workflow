...
- **Blocked by**: the ticket that produces the thing. This is the edge that matters most in the batch: when it is wrong, the person is sent to look at something that does not exist yet.
