...
6. Push the branch and open a pull request that references the ticket, its base the branch in `git config branch.issue-<n>.mmw-base-branch` (`main` when unset), pushed first if the remote lacks it.
