...
| --- | --- |
| a `ticket.bounced` newer than its newest `ticket.passed` | step 1, then step 4 onward: integrate and run the worker criteria, then make the final full run and close out |
