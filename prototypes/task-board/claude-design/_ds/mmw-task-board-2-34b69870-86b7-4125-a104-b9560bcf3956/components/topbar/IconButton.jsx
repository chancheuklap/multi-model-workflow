...
export function IconButton({icon, on, label, title, onClick, "data-ui": ui}) {
  return (
    <button type="button" className={on ? "gear on" : "gear"} aria-label={label} title={title}
      onClick={onClick} data-ui={ui} dangerouslySetInnerHTML={{__html: ICONS[icon]}}></button>
  );
}
