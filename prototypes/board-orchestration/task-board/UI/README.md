...
The design is ported into Claude Design as five components (the four regions of the board and the settings sheet of #335), one app page and an overview, bound to the `MMW Task Board` design system built from the repository's `DESIGN.md`:
