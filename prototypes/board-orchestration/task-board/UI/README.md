...
- The example data inside the mockup is fixed. It was written with the pipeline's event code of its time and is not regenerated; the current task board's example data is built by `prototypes/task-board/553/UI/build_scenes.py`.
