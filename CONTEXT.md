...
**验收完整性缺口**:
A review finding that a green `CHECK:` did not catch: the thing it names is broken or was never run. ADR 0012's second matching step opens a `senior-worker` ticket for it and requires a negative control; ADR 0008 is why.
