...
You receive recent user/assistant text and the stated understanding. You do not receive the session or its tool trace.
...
- Review diffs, tool traces, or whether work was executed. Verdict whether that understanding is wrong or incomplete.
