...
Acceptance maps each ticket criterion onto a spec seam or a human browser check, using commands the repo already has. Testing method stays in `/mmw-tdd` and the repo `TESTING.md`.
