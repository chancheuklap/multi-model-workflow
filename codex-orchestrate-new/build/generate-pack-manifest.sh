...
#
# Used by:
#   - plan_writer (optional helper to fill the Manifest table)
...
（生成器：codex-orchestrate-new/build/generate-pack-manifest.sh；Coordinator 派 Worker 前以 validate-pack-manifest.sh 做 Manifest / Pack 主体 / execution-state.packs keys 三方对账）
MEOF
)
