...
run_test "plan-review-resolution references canonical disposition-table" \
  grep -q '${MMW_PLUGIN_ROOT}/skills/_shared/disposition-table.md' "$PLUGIN_DIR/skills/orchestrate-plan-writing/references/plan-review-resolution.md"

run_test "design-review-angles references canonical disposition-table" \
  grep -q '${MMW_PLUGIN_ROOT}/skills/_shared/disposition-table.md' "$PLUGIN_DIR/skills/orchestrate-discovery/references/design-review-angles.md"
