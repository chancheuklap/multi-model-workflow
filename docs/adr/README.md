...
0002 与 0004 讲的界面 QA 已挂起：技能在 `deprecated/ui-qa`。设计系统是否被遵守、页面是否画对，由设计时截图检查（design-pages `references/edit-pages.md`）与 pull report（`references/pull.md`）承担。0011 推翻的是 #115「真状态加真容器」，不是 0002 / 0004。
