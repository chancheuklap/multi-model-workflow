...
篇幅：0008 至 0018 在 20 到 55 行之间，多数在 26 到 39 行。
...
| [0009](0009-night-orchestration-on-paseo.md) | 夜间编排从 Herdr 迁到 Paseo：脚本只做工具，判断归 main agent | 2026-09-06 | 无 | 0010、0018 |
...
| [0018](0018-runner-behind-one-boundary.md) | runner 收进一条边界：协议只调三个动词，一个 runner 一个适配器，今晚用哪个是本机一行配置 | 2026-09-10 | 0009、0016 | 无 |
