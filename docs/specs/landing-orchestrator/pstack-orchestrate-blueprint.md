> 逐字副本。来源：https://github.com/cursor/plugins `pstack/skills/poteto-mode/playbooks/orchestrate.md` @ commit 46125561（2026-08-20）。仅供 landing-orchestrator 技能作失败处理与简报蓝本引用，不是本仓约定。
