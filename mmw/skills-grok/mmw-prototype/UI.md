...
The durable files live where `mmw artifact path prototype` prints. The app keeps only the thin wiring that mounts them, and `README.md` lists every mount under `## Mounted wiring` so a later ticket can take them out.
