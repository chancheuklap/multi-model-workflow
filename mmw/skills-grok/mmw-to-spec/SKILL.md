---
name: mmw-to-spec
description: Turn the current conversation into a spec and publish it to the project issue tracker — no interview, just synthesis of what you've already discussed. Use when the user asks for a spec, or when `/mmw-grilling`, `/mmw-prototype`, or `/mmw-wayfinder` has settled the work.
---
...
Ask whether to send ① spec review (`/mmw-review`). Wait. If they say yes, the object is this spec; handle findings as `/mmw-review` specifies.
