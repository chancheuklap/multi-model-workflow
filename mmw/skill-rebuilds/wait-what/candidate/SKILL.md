...
| 把方案、文档或回复做成普通 HTML 可视化解释 | 完整读取 [VISUAL.md](VISUAL.md) |
| 用按钮手动驱动业务逻辑、状态转移或数据形状 | 完整读取 [LOGIC.md](LOGIC.md) |

普通 HTML 可视化解释帮助读者理解文档。Logic HTML 让读者实际操作状态模型。两者使用不同的流程和完成判据。
