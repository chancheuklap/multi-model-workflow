...
第一阶段已经完成上游 `SKILL.md` 和 `agents/openai.yaml` 的逐段中文翻译。第二阶段的精简稿与翻译基线逐字一致，没有删改上游方法。第三阶段在 `candidate/` 中加入已经确认的 Domain Modeling、事实调查、prototype、questionnaire、人工审批关卡和下游移交接线。当前发布技能仍未修改。
