...
| To click through a state model, data shape, or business logic | Invoke `$mmw:mmw-prototype`. Pass what they did not get, the path of any existing state model or script, and the question. It uses the Logic HTML branch. |
