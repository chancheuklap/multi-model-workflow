...
本轮只做了第 4 节的后端 prototype 时，用户给出意见后读取 [capture.md](capture.md)，保存本轮记录和下游输入；本轮做的是 UI mockup 或 Logic HTML 时，回 [UI.md](UI.md) 或 [LOGIC.md](LOGIC.md) 继续。
