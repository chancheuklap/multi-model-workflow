...
1. **它是 HITL 还是 AFK**——这件活要不要人在对话里参与才做得完。一件活只分这两种：
   ...
   这条轴跟**人工审批关卡**不是一回事：人工审批关卡是「必须用户点头这件事才能往下走」的关卡；HITL 说的是「这件活本身要人参与才做得完」。`$mmw:mmw-grilling` 要用户确认共同理解，`$mmw:mmw-to-spec` 第 7 步要用户确认 spec 定稿。这两处各自是对应产物的人工审批关卡。一件 AFK 的活也可能在后续流程遇到人工审批关卡。
