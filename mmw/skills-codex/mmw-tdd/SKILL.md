...
When the shape of that interface is itself in question — how deep the module is, where the seam belongs, what the interface should expose — use the `$mmw:mmw-codebase-design` skill for the vocabulary. It is the shared source of the module, interface, depth, seam, adapter, leverage and locality terms, and it is a reference to consult, not a session to run.
...
- **Refactoring is not part of the loop.** It belongs to the review stage (see `$mmw:mmw-review`), not the red → green implementation cycle.
