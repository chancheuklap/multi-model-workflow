...
| 情况 | 处理 |
| --- | --- |
| 报告交给用户了，第 2、3 节有要他裁决或回答的条目 | 等他逐条裁决，以及回答第 3 节那些「是不是同一件事」。他裁决完后，按 [VERDICTS.md](VERDICTS.md) 把裁决写进可用性判据，再报一次最终结果 |
| 报告交给用户了，第 2、3 节都是空的 | 本轮没有要他做的事，报告完就结束 |
| 被 `$mmw:mmw-prototype` 或 `$mmw:mmw-review` 叫起来，而且用户已经裁决完 | 把报告交回调用方 |
