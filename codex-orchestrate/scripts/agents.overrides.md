...
- Verification scripts must reject old worktree pseudo tools and custom worktree path instructions in Codex workflow references. Worktree placement belongs to Codex runtime, not shell scripts.
