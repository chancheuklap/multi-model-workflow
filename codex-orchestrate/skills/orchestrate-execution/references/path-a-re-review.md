...
bash "$PLUGIN_ROOT/scripts/review/review-lane.sh" submit --lane codex --review-kind code --resume --prompt-file <repair-review-prompt> --result-file <repair-review-result>
```
...
→ 走 Path B：send_input/resume_agent 给原 worker 执行修复
