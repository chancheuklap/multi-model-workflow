...
Generated with Codex Orchestrate + multi-model-workflow
```

### Step 22a：生成运行总结

```bash
bash "${PLUGIN_ROOT}/scripts/run-summary.sh" "<run_id>"
```
...
Push + PR 完成后，保留当前 Codex 工作树并记录分支名。不要自动删除工作树；PR 可能需要后续修改。
