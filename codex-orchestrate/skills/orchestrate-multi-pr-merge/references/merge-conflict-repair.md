...
| `needs repair` | worker 自己有疑虑 → 审阅 concerns，能自主解决则补充信息后 send_input/resume_agent worker 继续；否则进入 Step 14 让验证环节处理 |
| `needs context` | send_input/resume_agent 补充上下文给原 worker |
...
| 修复不正确但方向对 | send_input/resume_agent worker 附修正意见 → 重新验证 |
