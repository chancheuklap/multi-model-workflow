...
| **Cross-plan contract map** | `docs/orchestrate/plans/<slug>/cross-plan-contract-map.md`——跨 plan 连接面、producer / consumer / owner、验证方式和 Final Review 重点 |
...
| Cross-plan contract map 存在；无跨计划共享合同时明确写明独立性 | 返回 `NEEDS_PLAN_REVIEW` |
