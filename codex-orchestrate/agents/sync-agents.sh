...
agents = [
    ...
    ("docs_worker", "Low-risk documentation worker for mechanical cleanup, summaries, structure repair, and self-sufficient wording.", "agents/docs_worker.toml", ["Writer", "Editor", "Scribe"]),
]
